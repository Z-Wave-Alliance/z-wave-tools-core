...
namespace ZWaveTests.Security
{
    ...
    public class MpanTableTests
    {
        ...
        [Test]
        public void GetContainerByGroupIdIndex_PassInvalidGroupId_IsNull()
        {
            // Arrange.
            var mpanTable = new MpanTable();
            mpanTable.AddOrReplace(_nodeGroupId, _seqNo, _rgh, _mpanState);
            ...
            // Act.
            MpanContainer mpanContainer = mpanTable.GetContainer(invalidGroupId);
            Assert.IsNull(mpanContainer);
            // Assert.
        }
        ...
        public void Add_AddMoreThanMaxNonceTableCapacity_FirstAddedNonceRemovedFromTable()
        {
            ...
            {
                mpanTable.AddOrReplace(
                    new NodeGroupId(new NodeTag((ushort)(_nodeGroupId.Node.Id + 1 + i)), (byte)(_nodeGroupId.GroupId + 1 + i))
                    , _seqNo
                    , _rgh
                    , _mpanState);
            }
