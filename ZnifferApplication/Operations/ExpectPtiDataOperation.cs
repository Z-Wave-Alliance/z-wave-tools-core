...
{
    public class ExpectPtiDataOperation : CollectPtiDataOperation
    {
        public ExpectPtiDataOperation(byte[] homeId, byte? srcNodeId, Func<ActionToken, DataItem, bool> dataItemPredicate, int timeoutMs) :
