...
{
    public class CollectDataOperation : ActionBase
    {
        ...
        public CollectDataOperation(byte[] homeId, byte? srcNodeId, Func<ActionToken, DataItem, bool> dataItemPredicate, int timeoutMs) :
            base(false)
        {
            HomeId = homeId;
            SrcNodeId = srcNodeId;
    ...
    public class CollectDataResult : ActionResult
    {
        public int MaxCapacity { get; set; }
        public ConcurrentList<DataItem> DataItems { get; set; }
        public CollectDataResult(int maxCapacity)
        {
            MaxCapacity = maxCapacity;
            DataItems = new ConcurrentList<DataItem>(MaxCapacity);
        }

        public ConcurrentList<DataItem> ReturnAndReset()
        {
            return DataItems.ReturnAndReset();
        }
    }
}
