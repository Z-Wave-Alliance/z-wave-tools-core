...
namespace ZWave.BasicApplication.Operations
{
    public class SetLearnModeSecureOperation : ApiOperation
    {
        ...
        {
            Console.WriteLine(DateTime.Now.ToString("HH:mm:ss.fff") + " SetLearnModeSecureOperation: " + method);
        }
#endif
        ...
        {
#if MORE_DEBUG_LOGS
            PrintTimeStampAndName("OnMemoryGetIdCompleted");
#endif
        ...
        {
#if MORE_DEBUG_LOGS
            PrintTimeStampAndName("OnExpectSchemeGetCompleted");
#endif
        ...
        {
#if MORE_DEBUG_LOGS
            PrintTimeStampAndName("OnExpectKexGetCompleted");
#endif
            var lmc = _learnMode as SetLearnModeControllerOperation;
            var lms = _learnMode as SetLearnModeEndDeviceOperation;
        ...
        {
#if MORE_DEBUG_LOGS
            PrintTimeStampAndName("OnLearnModeCompleted");
#endif
        ...
        {
#if MORE_DEBUG_LOGS
            PrintTimeStampAndName("OnLearnModeS0Completed");
#endif
            SetStateCompleted(unit);
        }
        ...
        {
#if MORE_DEBUG_LOGS
            PrintTimeStampAndName("OnLearnModeS2Completed");
#endif
            SetStateCompleted(unit);
        }
