...
namespace ZWave.BasicApplication.Operations
{
    public class SetLearnModeControllerOperation : ApiOperation
    {
        ...
        {
            Console.WriteLine(DateTime.Now.ToString("HH:mm:ss.fff") + " SetLearnModeControllerOperation: " + method);
        }
#endif
        ...
        {
#if MORE_DEBUG_LOGS
            PrintTimeStampAndName("OnStarted");
#endif
